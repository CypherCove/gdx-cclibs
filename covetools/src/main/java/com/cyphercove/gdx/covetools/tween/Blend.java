...
/** An Interpolation with a derivative (speed) function so it can be smoothly interrupted with a {@link SplineBlend}
 * such as {@link #smooth} or {#link #smoother}.
 * <p>
 * Inner subclasses are based on those in the LibGDX Interpolation class, and have the same behavior as the similarly named
 * Interpolation instances.
 * @author cypherdare*/
public abstract class Blend extends Interpolation {
	 ...
	 * @param startSpeed Beginning rate of change. Used only by {@linkplain SplineBlend SplineBlends}.
	 * @param endSpeed Ending rate of change. Used only by {@linkplain SplineBlend SplineBlends}.
	...
	/** A blend interpolation that supports specific starting and ending speeds. If unspecified, the starting and/or ending speeds are
	 * set to zero. */
	public abstract static class SplineBlend extends Blend {
	...
	static public final SplineBlend smooth = new SplineBlend() {
	...
	static public final SplineBlend smoother = new SplineBlend() {
		public float apply (float a) {
	...
	/** See {@link #smoother}. */
	static public final SplineBlend fade = smoother;
	
	static public final Blend linear = new Blend() {
		public float apply (float a) {
			return a;
		}
	...
	static public final Blend sine = new Blend() {
		public float apply (float a) {
	...
	static public final Blend sineIn = new Blend() {
		public float apply (float a) {
			return 1 - MathUtils.cos(a * MathUtils.PI / 2);
		}
	...
	static public final Blend sineOut = new Blend() {
		public float apply (float a) {
	...
	static public final Blend circle = new Blend() {
		public float apply (float a) {
			if (a <= 0.5f) {
				a *= 2;
	...
	static public final Blend circleIn = new Blend() {
		public float apply (float a) {
	...
	static public final Blend circleOut = new Blend() {
		public float apply (float a) {
			a--;
	...
	static public class Pow extends Blend {
		final int power;
	...
	static public class Exp extends Blend {
	...
	static public class Elastic extends Blend {
	...
	static public class BounceOut extends Blend {
	...
	static public class Swing extends Blend {
	...
	static public class SwingOut extends Blend {
		private final float scale;
	...
	static public class SwingIn extends Blend {
		private final float scale;
