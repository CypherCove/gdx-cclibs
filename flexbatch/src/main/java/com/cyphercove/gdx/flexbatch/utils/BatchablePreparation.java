...
public final class BatchablePreparation {
	...
	/** Populates an array of triangle indices for quadrangles made up of two triangles. The indices are ordered
	 * such that they produce counter-clockwise-wound triangles if the vertices are ordered as follows:
	 * <code><br>
	 * <br>2--3
	 * <br>| /|
	 * <br>|/ |
