...
public class AttributeOffsets {
	...
	public AttributeOffsets (VertexAttributes attributes){
		...
		int color0 = 0, color1 = 0, color2 = 0, color3 = 0,
		textureCoordinate0 = 0, textureCoordinate1 = 0, textureCoordinate2 = 0, textureCoordinate3 = 0, 
		generic0 = 0, generic1 = 0, generic2 = 0, generic3 = 0;
		for (int i=0; i<byIndex.length; i++){
			...
			case Usage.ColorUnpacked:
				switch (cIdx++){
				case 0: color0 = offset; break;
				case 1: color1 = offset; break;
				case 2: color2 = offset; break;
				case 3: color3 = offset; break;
				}
				break;
			case Usage.TextureCoordinates:
				switch (tcIdx++){
				case 0: textureCoordinate0 = offset; break;
				case 1: textureCoordinate1 = offset; break;
				case 2: textureCoordinate2 = offset; break;
				case 3: textureCoordinate3 = offset; break;
				}
				break;
			case Usage.Generic:
				switch (gIdx++){
				case 0: generic0 = offset; break;
				case 1: generic1 = offset; break;
				case 2: generic2 = offset; break;
				case 3: generic3 = offset; break;
				}
				break;
			}
		}
