...
public interface SortableBatchable<T extends Batchable>{
	 ...
	 * @return Whether this Batchable and the other have the same texture configuration such that they could 
	 * be drawn sequentially without forcing the FlexBatch to flush in between. */
